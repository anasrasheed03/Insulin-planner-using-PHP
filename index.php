...
<head>
    ...
    <title>Login - Insulin Planner System</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(/portal2/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="http://farwa.logicalhive.com/images/logo.png" alt="logo" width="200" height="90" /></span>
                        <span class="db"><h3>Insulin Planner System</h3></span>
