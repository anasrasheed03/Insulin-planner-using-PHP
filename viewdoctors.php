...
<head>
    ...
    <title>Doctors List - Insulin Planner System</title>
                ...
                <div class="row"> 
                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                                    ...
                                    <tbody>
                                        <?php
                         $search_query2="SELECT * FROM doctor";
                        ...
                        if($_SESSION["useraccess"]==0){
                        ?>
                                            <td><a href="config/deletedoc.php?id=<?php echo $email ?>"><button type="button">Delete Doctor</button></a></td>
                          <?php 
                        }
                          ?>
                                              </tr>
